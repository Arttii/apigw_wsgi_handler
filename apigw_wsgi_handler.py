...
Authors: Logan Raarup <logan@logan.dk>, Artyom Topchyan <artyom.topchyan@live.com>
"""
...
def get_handler(wsgi_app):
    """
    Returns wrrapper wsgi handler for wsgi_app
    """
    def wrapper(event, context):
        return handler(wsgi_app, event, context)
    return wrapper
